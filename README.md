...
5. [op7418/guizang-s-prompt](https://github.com/op7418/guizang-s-prompt): 这里是歸藏的提示词储存库，存放着歸藏撰写的所有 AI 模型提示词（This is Guizang's prompt repository, containing all AI model prompts written by Guizang.）
