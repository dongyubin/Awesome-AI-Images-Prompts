...
- [AesthAI by Omvela](https://aesthai.omvela.com/)（[官方索引](https://github.com/cdxiaodong/aesthai)）：生图案例、图像生成 Skill 与视觉方法库，逐条记录来源、复现步骤和授权边界，并提供可调节的视觉方法工作台。
...
```markdown
使用教授白板图像：包含图表、箭头、方框和说明文字，以视觉方式解释核心概念。同时使用多种颜色。(不用出现人物形象) 内容为：
```

![教授白板风格图片](images/Professor_whiteboard_style.webp)
...
![票据风格 (ticket)](images/bill-style.webp)
...
![矢量插画封面](images/20260613-矢量插画封面.jpg)
...
![强叙事自媒体封面](images/20260613-强叙事自媒体封面.jpg)

### 黑白灰先锋海报设计

[来源X](https://x.com/AdrianPunk115/status/2064944838035022034)
...
![黑白灰先锋海报设计](images/20260613-黑白灰先锋海报设计.jpg)

## AI生图提示词展示案例

### 中式天庭+东方神话+巨型建筑

- 使用模型： [GPT Image 2](https://gptimage2.wwkejishe.top/) 

将下面提示词按照下面提示词场景进行填空，也可以让AI自行组合给你一个完整的提示词：
...
```
- [场景主体]：通天长桥 / 云端石阶 / 飞檐长廊 / 主殿群落 / 云上神门
- [建筑结构]：白玉栏杆、巨柱、飞檐、斗拱、龙纹浮雕、宫阙群
- [环境元素]：云海、云瀑、体积光、薄雾、逆光、天穹裂隙
- [远景目标]：主殿 / 天门 / 神宫 / 云端终点 / 圣域入口
- [遮挡方式]：云层遮挡 / 强光遮挡 / 光雾遮挡 / 云瀑遮挡
- [人物数量与身份]：一位红袍旅者 / 两位古代朝圣者 / 一组极小人物
- [人物动作]：缓步前行 / 登阶而上 / 停驻仰望 / 朝向宫殿行进
- [异象元素]：天空裂开的光门 / 巨型神鲸盘旋 / 龙影穿云 / 神光降临
- [光线类型]：金色晨光 / 神圣逆光 / 暖白天光 / 夕照体积光
- [色彩方案]：暖金 + 米白 + 青灰 / 深蓝灰 + 金光 + 白石 / 柔白 + 琥珀金 + 雾蓝
- [镜头构图]：超宽银幕远景 / 中轴对称 / 强透视引导线 / 低机位仰望
- [情绪关键词]：神圣、空灵、庄严、静谧、史诗、崇高、梦境般超现实
```

![东方超现实神殿美学](https://cdn.wwkejishe.top/wp-cdn-02/2026/20260824213826249.webp)
...
![2026-05-11-东方神话人物志百科海报](images/2026-05-11-东方神话人物志百科海报.jpg)
