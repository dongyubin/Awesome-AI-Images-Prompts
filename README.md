...
3. [OpenNana提示词图库](https://opennana.com/awesome-prompt-gallery/)：🍌Nano Banana - nanobanana, gpt4o, chatgpt 提示词案例库
...
9. [Nano Banana Pro提示词图库 | AI图片提示词案例 | OpenNana](https://opennana.com/awesome-prompt-gallery)：1300+个提示词
10. [Nano Banana Pro Prompts - 高质量 AI 提示词与图像生成 - YouMind](https://youmind.com/zh-CN/nano-banana-pro-prompts)
    - 使用 [YouMind注册](https://youmind.com/invite/6JGI8C)：可以多获得 1000 积分，又可以多生成 66 张图片了。
11. [Nano Banana Pro 提示词宝库 | 高质量 AI 绘画提示词](https://nanobanana.pixtoai.com/)
12. [AiWind - AI Prompt Library](https://www.aiwind.org/)：1000+个提示词
13. [Nano Banana Prompt Gallery - Nano Banana Prompt](https://nanobananaprompt.org/prompts/)
